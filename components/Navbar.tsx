          ...
          <div className="md:hidden py-4 border-t">
            <div className="flex flex-col space-y-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg transition-colors font-medium flex items-center justify-center gap-2 mx-2"
                onClick={() => setIsMenuOpen(false)}
              >
                <svg
                  className="w-5 h-5"
              ...
              <Link
                href="/admin"
                className="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg transition-colors font-medium flex items-center justify-center gap-2 mx-2"
                onClick={() => setIsMenuOpen(false)}
              >
                <svg
                  className="w-5 h-5"
